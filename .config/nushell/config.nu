...
alias e = hx
alias eO = nvim -O
alias eX = hx ~/.XCompose
alias ebsp = hx ~/.config/bspwm/bspwmrc
alias ed = nvim -d
alias eenv = hx ~/.config/nushell/env.nu
alias ehk = hx ~/.config/sxhkd/sxhkdrc
alias ehx = hx ~/.config/helix/config.toml
alias en = hx ~/.config/nushell/config.nu
alias eo = nvim -o
alias ep = nvim -p
alias epb = hx ~/.config/polybar/config.ini
alias epi = hx ~/.config/picom/picom.conf
alias ex = hx ~/.xinitrc
alias ez = hx ~/.zshrc
alias eze = hx ~/.zshenv
alias ezp = hx ~/.zprofile
...
alias gsls = cd ~/Code/Software/suckless/slstatus
...
alias pmss = doas pacman -Ss
alias pmu = doas pacman -Syyuu
alias pt = pactree -c
alias py = python
alias q = exit
alias russy = rustup
...
alias x = eza --icons
alias xa = eza --icons --tree --level=1 --all
alias xal = eza --icons --tree --level=1 --all --long
alias xl = eza --icons --tree --level=1 --long --git
...
$env.config = {
  ...
  completions: {
    ...
    external: {
      ...
      max_results: 16 # setting it lower can improve completion performance at the cost of omitting some options
